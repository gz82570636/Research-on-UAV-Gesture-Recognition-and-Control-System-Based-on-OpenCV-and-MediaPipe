...
本项目为珠海科技学院毕业设计论文的工程实现：

> **基于OpenCV与MediaPipe的无人机手势识别控制系统研究**
> 
> 作者：陈嘉威 (16220618)
> 
> 学院：智能制造与航空学院
...
### 论文核心贡献
1. 构建了低成本全链路硬件架构，以香橙派3B为核心计算单元
2. 设计了非模型化的高效手势解析算法，基于空间解析几何实现轻量化识别
3. 打通了"手势采集-识别-指令映射-飞控通信"全链路闭环
4. 完成了双环境（仿真+实物）严格测试与性能验证
...
<p align="center">
  <b>Made with ❤️ by 陈嘉威 | 珠海科技学院</b><br>
  <i>让无人机控制像挥手一样简单</i>
</p>
